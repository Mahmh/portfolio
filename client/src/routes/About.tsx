      ...
      <section id="about">
        ...
        <div className="about-wrapper">
          <div className="about-content">
            <p>
              I'm Maher Mahmoud — a full-stack engineer and AI tinkerer
              passionate about building intelligent, elegant, and performant
              digital products. My journey into computer science has been
            ...
            <p>
              Over the years, I've built projects spanning from{" "}
              <b>
                AI-powered web apps and semantic search engines to
            ...
            <p>
              I’ve been an engaged member of the Association for the Advancement
              of Artificial Intelligence (AAAI) since 2024. While I’ve only
              participated in one of their annual hackathons so far, I regularly
              follow their publications to stay current with emerging trends in
              the field.
            </p>
            ...
            <p>
              ...
              <b>open doors to meaningful opportunities</b>.
            </p>
